...
@Getter
public class GetFeedResp {
    private final GetFeedDTO content;

    public GetFeedResp(GetFeedDTO content) {
    ...
    public static class GetFeedDTO {
        ...
        public GetFeedDTO(FeedDTO feed, RestaurantDTO restaurant, boolean isFollowed, boolean isLiked) {
            this.feed = feed;
