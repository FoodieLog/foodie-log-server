...
public class JwtTokenProvider {
    ...
    public void checkPair(String accessToken, String refreshToken) {
        String email = getEmail(accessToken);
        String redisRT = redisService.getObjectByKey(RedisService.REFRESH_TOKEN_PREFIX + email, String.class);
